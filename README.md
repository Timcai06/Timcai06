...
```
EN:  Freshman based in Shanghai. Passionate about AI/ML, quantitative finance,
     and full-stack development. Building practical tools — from PyTorch training
     observability to drone bridge inspection AI and stock prediction platforms.

CN:  上海大一学生，热爱 AI/ML、量化金融、全栈开发。
     从 PyTorch 训练可视化、无人机桥梁检测到股市预测，每个仓库都是一次学习。
```
